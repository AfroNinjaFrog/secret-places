...
namespace SecretPlaces.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,ReviewID,Content,CreationDate")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,ReviewID,Content,CreationDate")] Comment comment)
        {
            if (id != comment.ID)
            {
                return NotFound();
